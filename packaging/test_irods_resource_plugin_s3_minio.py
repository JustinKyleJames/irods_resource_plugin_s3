...
from resource_suite_s3_nocache_minio import Test_S3_NoCache_Base_Minio
...
class Test_Compound_With_S3_Resource_Minio(ResourceSuite, ChunkyDevTest, unittest.TestCase):
    ...
    def setUp(self):
        ...
        s3params = 'S3_RETRY_COUNT=15;S3_WAIT_TIME_SEC=1;S3_PROTO=HTTP;S3_MPU_CHUNK=10;S3_MPU_THREADS=4;S3_ENABLE_MD5=1'
        ...
        super(Test_Compound_With_S3_Resource_Minio, self).setUp()

    def tearDown(self):
        super(Test_Compound_With_S3_Resource_Minio, self).tearDown()
    ...
    def test_irepl_update_replicas(self):
        ...
        self.admin.assert_icommand("ils -L "+filename,'STDOUT_SINGLELINE',[" 0 "," & "+filename]) # should have a dirty copy
        self.admin.assert_icommand("ils -L "+filename,'STDOUT_SINGLELINE',[" 1 "," & "+filename]) # should have a dirty copy
        self.admin.assert_icommand("ils -L "+filename,'STDOUT_SINGLELINE',[" 2 "," & "+filename])     # should have a clean copy
        self.admin.assert_icommand_fail("ils -L "+filename,'STDOUT_SINGLELINE',[" 3 "," & "+filename]) # should have a dirty copy
        self.admin.assert_icommand_fail("ils -L "+filename,'STDOUT_SINGLELINE',[" 4 "," & "+filename])     # should have a dirty copy
    ...
    def test_multiple_s3_endpoints_replication_issue1858(self):
        ...
        hostname = lib.get_hostname()
        s3params_aws = 'S3_RETRY_COUNT=1;S3_WAIT_TIME_SEC=1;S3_PROTO=HTTP;S3_MPU_CHUNK=10;S3_MPU_THREADS=4;S3_ENABLE_MD5=1'
...
class Test_Compound_With_S3_Resource_Minio_EU_Central_1(Test_Compound_With_S3_Resource_Minio):
    '''
...
class Test_S3_NoCache_V4(Test_S3_NoCache_Base_Minio, unittest.TestCase):
...
class Test_S3_NoCache_EU_Central_1(Test_S3_NoCache_Base_Minio, unittest.TestCase):
    '''
    This also tests signature V4 with the x-amz-date header.
    '''
    def __init__(self, *args, **kwargs):
